var avengerNames = ["Iron Man", " Black Panther", " Captain America", " Black Widow", " Gamora", " Starlord", " Hulk", " Thor", " Bucky"];
var avengerPics = [
    ...
    "https://vignette.wikia.nocookie.net/marvelcinematicuniverse/images/4/41/Winter_Soldier_AIW_Profile.jpg/revision/latest/scale-to-width-down/310?cb=20180525203553",
];
var nope = 0;
$("button").click(function() {
    // YOUR CODE GOES INSIDE HERE
avengerPics.forEach(function(memes) {
    $("body").append("<div>"+avengerNames[nope]+"</div>");
    nope = nope +1;
    $("body").append("<div>"+"<img src=" + memes + ">"+"</div>");
});  
});